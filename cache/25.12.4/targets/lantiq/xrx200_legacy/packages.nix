{
  ...
  base-files = {
    ...
    sha256 = "b642546de56832116854b6f441eb0d52166829e82306dbf4e5ba60f6a5ef5a3b";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.87~5b7c63f2928ef14d07789174b006b99e-r1";
    filename = "kernel-6.12.87~5b7c63f2928ef14d07789174b006b99e-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "bab0a3d20b4500dfef6005b3b02194f020fe17e22a38c4fbf6f2483cb835fed1";
  };
  libatomic1 = {
    version = "14.3.0-r5";
