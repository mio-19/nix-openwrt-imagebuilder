{
  ...
  base-files = {
    ...
    sha256 = "37eae2b89fb5fcaddb87a25cc98d4c9c659142e040008891be5d3ef7d53bb662";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.87~107ac75f29f9a81f6da44b5b0e33df29-r1";
    filename = "kernel-6.12.87~107ac75f29f9a81f6da44b5b0e33df29-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "86123e0e3d3160de46785095fc131ec67f4466f83141a1261a47f975a1a27549";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "f729233427df8dcfe9db1d6c2a416387bc8cf92803a9c5652b000ec2934df7b2";
  };
  snapshot-tool = {
    version = "2026.02.15~8d377aa6-r1";
