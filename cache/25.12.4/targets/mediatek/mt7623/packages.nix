{
  ...
  base-files = {
    ...
    sha256 = "5e086c431928e77bfb78ed7d7c107aa969b911542e426edcb9c9515cc3fcb71e";
  };
  block-mount = {
  ...
  fitblk = {
    ...
    provides = [ "fitblk-any" ];
    sha256 = "102ee43feeac78a85e5c1a0d725c0693908f2c4efd23955daaa726d8821144f3";
  };
  fstools = {
    version = "2026.02.15~8d377aa6-r1";
  ...
  kernel = {
    version = "6.12.87~10174daa8e2344511ad80dc52f46bc7b-r1";
    filename = "kernel-6.12.87~10174daa8e2344511ad80dc52f46bc7b-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "9ff6f865aefbe65ed237018712ecf68d7795cc67651fca8b741db00b71b96d02";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    provides = [ "mtd-any" ];
    sha256 = "d5f0f3e2681a75653813a31b8c317f42b9074d193543c2c7bff32a3334c56f75";
  };
  nand-utils = {
    version = "2.3.0-r1";
  ...
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "a84330d87e6dee438cd4d761dffba55f2b1bbd176fb88d4fc0b6d3e8f52d72e4";
  };
  snapshot-tool = {
    version = "2026.02.15~8d377aa6-r1";
  ...
  uboot-envtools = {
    ...
    sha256 = "f4e453736f83b15228a5fcc969e103851fa3183f880071e2a8875438d3d162a1";
  };
  umbim = {
