{
  ...
  base-files = {
    ...
    sha256 = "90bc7480ea4089155a6240161cc5100fc0e71b943144c18cd11294af1cb28def";
  };
  block-mount = {
  ...
  grub2-efi-arm = {
    ...
    depends = [ "libc" ];
    provides = [ "grub2-efi-arm-any" ];
    sha256 = "202ed451831f55dbe37c1910f3cd8e18c19790bb5e3db52da6470b3499f10e6e";
  };
  ip6tables-extra = {
    version = "1.8.10-r3";
  ...
  kernel = {
    version = "6.12.87~1f1a8723cca69c83dc152592510e876a-r1";
    filename = "kernel-6.12.87~1f1a8723cca69c83dc152592510e876a-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "586855b808c1190f3087fdd8bd87b8ecbc8baed6276cd120c1fec028df9fca19";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "bb47249835eea0738a063a787e45a37d4ed6895f5f4ab65e6b1141799ac9c3f6";
  };
  snapshot-tool = {
    version = "2026.02.15~8d377aa6-r1";
  ...
  uboot-envtools = {
    ...
    sha256 = "c29185dc17ffa85b3f6a7cd2a00c1a1db356b91405e4af9f637ff006053843ef";
  };
  umbim = {
