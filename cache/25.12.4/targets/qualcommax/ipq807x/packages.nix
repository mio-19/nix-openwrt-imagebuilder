{
  ...
  base-files = {
    ...
    sha256 = "cdfb423a4edc56a8e09928990e86a157a5688f48c24dea30a9783973090fd64d";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.87~3d7d87f192c223e4910f823c81da8927-r1";
    filename = "kernel-6.12.87~3d7d87f192c223e4910f823c81da8927-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "a1ac94c3bbac225ef0dfaecfa42f4ed20e731cae87042d579861bd1c1821be07";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "c6ba267e9bf10d5a040ca5be7ffbccf8ae5df096e9b303819de79720d74df236";
  };
  snapshot-tool = {
    version = "2026.02.15~8d377aa6-r1";
  ...
  uboot-envtools = {
    ...
    sha256 = "6b16b9c3156543318ac30a74c56fa068a6faa111ffb0855c3dde4afb7c7feca4";
  };
  umbim = {
  ...
  zyxel-bootconfig-ipq807x = {
    version = "1";
    filename = "zyxel-bootconfig-ipq807x-1.apk";
    depends = [ "libc" ];
    provides = [ "zyxel-bootconfig-ipq807x-any" ];
    sha256 = "754a836b24a4c19a55b6daf753df862ca21f6eca84f9c26eaad65a4b689d8aa3";
  };
}
